    ...
    while true; do
        ...
        case $t in
            ...
            8)
                ...
                bash <(curl -s https://raw.githubusercontent.com/erymont329/The-Coding-Hub/refs/heads/main/srv/tools/rdp.sh)
                pause ;;

            9)
                echo -e "\n${YELLOW}⚙ Installing SSL Panel...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/erymont329/hub/refs/heads/main/Codinghub/toolbox/mengssl.sh)
                pause ;;
