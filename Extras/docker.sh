...
function create_container() {
    ...
    case ${OS_CHOICE:-1} in
      1) IMAGE="erymonta/ubuntu:22" ; DEFAULT_HOST="ubuntu22" ;;
      2) IMAGE="erymonta/ubuntu:24" ; DEFAULT_HOST="ubuntu24" ;;
      3) IMAGE="erymonta/debain:11" ; DEFAULT_HOST="debian11" ;;
      4) IMAGE="erymonta/debain:12" ; DEFAULT_HOST="debian12" ;;
      5) IMAGE="erymonta/debain:13" ; DEFAULT_HOST="debian13" ;;
      *) IMAGE="erymonta/debain:12" ; DEFAULT_HOST="debian12" ;;
    esac
